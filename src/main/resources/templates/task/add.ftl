    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Форма создания задачи <small></small></h2>
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" action="/task/add" method="post" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <div class="col-md-5 xdisplay_inputx form-group has-feedback">
                                                    <input type="text" required name="endDate" class="form-control has-feedback-left" id="enddate" placeholder="Выбери дату" aria-describedby="inputSuccess2Status4">
                            ...
                            <div class="form-group">
                                <label for="project" class="control-label col-md-3 col-sm-3 col-xs-12">Проект</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div id="project" class="btn-group" data-toggle="buttons">
                                        <select class="select2_single form-control" id="project" required name="projectId">
